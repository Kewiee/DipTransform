function [x_out, output] = HyBR_lsmr(A, b, options)
%
% [x_out, output] = HyBR_lsmr(A, b, options)
%
...
%   [4] Chung and Palmer, "A Hybrid LSMR Algorithm for Large-Scale Tikhonov 
%       Regularization", SISC 2015
%
% J. Chung and K. Palmer, 2014
%
...
for i = 1:maxiter+1 %Iteration (i=1) is just an initialization
  [U, B, V, alphakp1, vkp1] = feval(handle, A, U, B, V, options, alphakp1, vkp1);
