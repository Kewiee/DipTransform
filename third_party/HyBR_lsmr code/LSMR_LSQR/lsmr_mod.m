function [x, Xall, istop, itn, normr, normAr, normA, condA, normx]...
   = lsmr_mod(A, b, lambda, atol, btol, conlim, itnlim, localSize, show)

 % Modified LSMR to send out solutions at all iterations
 %
