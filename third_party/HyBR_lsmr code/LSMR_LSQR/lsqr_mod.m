function [ x, Xall, istop, itn, r1norm, r2norm, anorm, acond, arnorm, xnorm, var ]...
  = lsqr_mod( m, n, A, b, damp, atol, btol, conlim, itnlim, show )
%
% Modified LSQR to send out solutions at all iterations
%
